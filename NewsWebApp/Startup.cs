...
namespace NewsWebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "NewsWebApp", Version = "v1" });
            });
            services.AddCoreDbContext(Configuration);
            services.AddScoped<IAuthenticatiRepository, AuthenticatiRepository>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "NewsWebApp v1"));
            }
